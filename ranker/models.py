...
class Project(models.Model):
    ...
    likert_label_1 = models.CharField(max_length=200)
    likert_label_2 = models.CharField(max_length=200)
    likert_label_3 = models.CharField(max_length=200)
    likert_label_4 = models.CharField(max_length=200)
    ...
    last_model_estimation = models.DateTimeField(default=datetime.now)
